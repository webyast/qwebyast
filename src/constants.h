#define WEBYAST_UP_ICON		"/usr/share/icons/hicolor/16x16/apps/qwebyast/pics/qwebyast_green.png"
#define WEBYAST_DOWN_ICON	"/usr/share/icons/hicolor/16x16/apps/qwebyast/pics/qwebyast_gray.png"
